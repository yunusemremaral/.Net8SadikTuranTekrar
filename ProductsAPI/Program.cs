...
builder.Services.AddAuthentication(x => {
    ...
    x.RequireHttpsMetadata = false;    // sadece güvenli 
    x.TokenValidationParameters = new TokenValidationParameters
    {
        ValidateIssuer = false, // yayýnlayan kisi 
        ValidIssuer = "yunusemre.com",  
        ValidateAudience = false,  // apiyi kim için yaptýk ...
        ValidAudience = "",
...
builder.Services.AddSwaggerGen(option =>   // sadece bu  postman gibi header ekleme kýsmý eklendi ... 
{
